...
.results-list h2 { color: white; font-size: 1.1rem; margin-bottom: 1rem; }
...
.result-name { color: rgba(255,255,255,0.8); }
.result-score { color: white; font-weight: 700; font-size: 1.1rem; }
</style>
