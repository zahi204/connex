...
.results-list h2 { color: white; font-size: 1.1rem; margin-bottom: 0.75rem; }
.result-card { background: rgba(255,255,255,0.05); border-radius: 8px; padding: 0.75rem 1rem; display: flex; align-items: center; justify-content: space-between; margin-bottom: 0.5rem; }
.result-name { color: white; font-weight: 500; margin-bottom: 0.2rem; }
.result-meta { display: flex; gap: 0.75rem; color: rgba(255,255,255,0.5); font-size: 0.8rem; }
.suitability-badge { padding: 0.1rem 0.5rem; border-radius: 12px; font-size: 0.7rem; }
.suitability-badge.suitable { background: rgba(34,197,94,0.2); color: #4ade80; }
.suitability-badge.conditional { background: rgba(234,179,8,0.2); color: #facc15; }
.suitability-badge.unsuitable { background: rgba(239,68,68,0.2); color: #f87171; }
.result-score { color: white; font-weight: 700; font-size: 1.2rem; }
</style>
