  ...
  <div class="portal-layout">
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <NuxtLink to="/worker" class="nav-item">Dashboard</NuxtLink>
        <NuxtLink to="/worker/profile" class="nav-item">Profile</NuxtLink>
        <NuxtLink to="/worker/assignments" class="nav-item">Assignments</NuxtLink>
        <NuxtLink to="/worker/team" class="nav-item">My Team</NuxtLink>
        <NuxtLink to="/worker/training" class="nav-item">Training</NuxtLink>
        <NuxtLink to="/worker/documents" class="nav-item">Documents</NuxtLink>
        <NuxtLink to="/worker/payments" class="nav-item">Payments</NuxtLink>
        <NuxtLink to="/worker/notifications" class="nav-item">Notifications</NuxtLink>
      </nav>
    </aside>
