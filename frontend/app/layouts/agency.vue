  ...
  <div class="portal-layout">
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <NuxtLink to="/agency" class="nav-item">Dashboard</NuxtLink>
        <NuxtLink to="/agency/profile" class="nav-item">Profile</NuxtLink>
        <NuxtLink to="/agency/workers" class="nav-item">My Workers</NuxtLink>
        <NuxtLink to="/agency/training" class="nav-item">Training Results</NuxtLink>
        <NuxtLink to="/agency/billing" class="nav-item">Billing</NuxtLink>
        <NuxtLink to="/agency/notifications" class="nav-item">Notifications</NuxtLink>
      </nav>
    </aside>
